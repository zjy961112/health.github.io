...
public class MessageConstant {
    ...
    public static final String DELETE_CHECKGROUP_CHECKITEM_FAIL = "检查项跟检查组存在关系，无法删除";
    public static final String DELETE_SETMEAL_CHECKGROUP_FAIL = "套餐跟检查组存在关系，无法删除";
    ...
    public static final String IMPORT_FAIL = "导出失败，请联系管理员";
    ...
    public static final String VALIDATECODE_DATED = "验证码已过期，请重新获取";
    ...
    public static final String QUERY_SETMEAL_CHECKGROUP_SUCCESS = "查询套餐对应的检查组成功";
    public static final String QUERY_SETMEAL_CHECKGROUP_FAIL = "查询套餐对应的检查组失败";
}
